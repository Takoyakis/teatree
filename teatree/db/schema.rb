...
ActiveRecord::Schema.define(version: 20160323120538) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "favorite_leaf",          limit: 255
    t.text     "favorite_shop",          limit: 65535
    t.text     "preference",             limit: 65535
    t.integer  "favorite_tea_type",      limit: 4
  end
